              ...
              ({ pageLabel, pageLink }, index) => (
                <div key={index} className="ml-8">
                  <Button
                    ...
                    variant="neutral"
                    className={` ${`px-[0.75rem] py-[0.75rem] font-ABCWhyteEdu_Medium text-pSMSemiBold font-semibold tracking-[0.02em] text-neutral-50 hover:text-neutral-65 dark:text-neutral-30 dark:hover:text-neutral-15`} ${

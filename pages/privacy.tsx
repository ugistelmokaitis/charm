...
const introComponents: JSXMapSerializer = {
  ...
  paragraph: ({ children, key, ...props }) => (
    <p
      key={key}
      className="inline font-ABCWhyteEdu_Regular text-pSMRegular font-normal tracking-[0.02em] text-neutral-100 dark:text-neutral-15 md:text-pLGRegular"
      {...props}
    >
      {children}
    </p>
        ...
        <div className=" text-white-100 grid-cols-1 gap-16 md:grid md:grid-cols-12 md:gap-8">
          <div className="col-span-4 pt-56 md:col-span-9 lg:col-span-7">
            ...
            <div className="mb-12 mt-12">
              <p className="font-ABCWhyteEdu_Medium text-pSMSemiBold font-normal tracking-[0.02em] text-neutral-100 dark:text-neutral-15 md:text-pMDSemiBold">

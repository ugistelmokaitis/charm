          ...
          <div key={index} className="pt-20 lg:pt-28">
            ...
            <div className="mt-12 gap-16 md:grid-cols-12 lg:grid">
              <div className="col-span-6 col-start-3">
                ...
                <PrismicLink document={casestudy}>
                  <div className="font-ABCWhyteEdu_Heavy text-5xl font-bold tracking-[0.02em] text-neutral-100 hover:text-neutral-50 dark:text-neutral-0 dark:hover:text-neutral-30 lg:text-3xl">
                    {casestudy.data.workpageTitle}
                  </div>
                </PrismicLink>
                <div className="mt-8 inline-block lg:mt-12">
                  <span className="font-ABCWhyteEdu_Medium  text-pSMSemiBold font-normal tracking-[0.02em] text-neutral-100 dark:text-neutral-0 lg:text-pLGSemiBold">
